...
<body>
    ...
    <header class="bg-white shadow-sm sticky-top">
        <div class="container">
            <div class="d-flex align-items-center py-3">
                ...
                <h5 class="mb-0 fw-bold text-gradient">Thông Tin Đặt Hàng</h5>
            </div>
        </div>
    </header>
    ...
    <div class="container-fluid py-4" style="background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%); min-height: 100vh;">
        <div class="container">
            <div class="row g-4">
                ...
                <!-- SUMMARY -->
                <div class="col-lg-4">
                    <div class="bg-white rounded-3 shadow p-4 sticky-top" style="top: 100px;">
                        <h5 class="mb-4 fw-bold text-dark">Tóm Tắt Đơn</h5>

                        <div id="orderSummary" class="mb-4 pb-3 border-bottom">
                            <!-- Sản phẩm sẽ được hiển thị ở đây -->
                            <div class="d-flex justify-content-between mb-2">
                                <span class="small">Hoa Cúc Trắng Thuần Khiết (x1)</span>
                                <span class="small fw-semibold">180.000 ₫</span>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 pb-3 border-bottom">
                            <div class="d-flex justify-content-between mb-2 small">
                                <span>Tạm tính:</span>
                                <span id="summarySubtotal">180.000 ₫</span>
                            </div>
                            <div class="d-flex justify-content-between small">
                                <span>VAT (10%):</span>
                                <span id="summaryVAT">18.000 ₫</span>
                            </div>
                        </div>

                        <div class="d-flex justify-content-between mb-4 fw-bold fs-5">
                            <span>Tổng cộng:</span>
                            <span class="text-primary" id="summaryTotal">198.000 ₫</span>
                        </div>
    ...
    function setMinDeliveryDate() {
        ...
        // Set giá trị mặc định là ngày mai
        if (!$('#deliveryDate').val()) {
